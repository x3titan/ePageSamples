...
namespace TamPub1 {
    ...
    public class IPClient {
        ...
        public OnConnect onConnect = null;
    ...
    public class ConfigFileXml {
        ...
        public static int checkKey(string filename, string key) {
            ...
            System.Xml.XmlNode lastNode = xmlDoc.SelectSingleNode("root");
            ...
            while (true) {
                ...
                node = xmlDoc.SelectSingleNode("root/" + key.Substring(0, sp1));
                if (node == null) {
        ...
        public static bool writeString(string filename, string key, string value) {
            ...
            System.Xml.XmlDocument xmlDoc = new System.Xml.XmlDocument();
            xmlDoc.Load(filename);
            System.Xml.XmlNode node = xmlDoc.SelectSingleNode("root/" + key);
